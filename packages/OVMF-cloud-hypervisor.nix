# We Add this module, because we need changes enabling aarch64 ovmf support for cloud hypervisor
# The module can be removed, when https://github.com/NixOS/nixpkgs/pull/450675 is available in nixos-unstable at least.
{
  stdenv,
  nixosTests,
  lib,
